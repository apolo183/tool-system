...
module_compound_contract:
  ...
  replacement_contract:
    activation_rule: Replace only after adapter contract, worker conversion, default no-mutation, guarded subscription preflight, fake-process stdin/argv/approval/config-isolation/environment/private-schema/final-message/output/timeout/process-group-cancellation, strict structured-patch, orchestration, nested-policy, audit-write, and rollback tests pass.
