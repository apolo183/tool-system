...
def main() -> int:
    parser = argparse.ArgumentParser(description="Preview a target repository pull request without writing the target repo.")
    ...
    parser.add_argument("--audit-path", type=Path, default=Path("artifacts/target_repo_pr_plan_preview.jsonl"))
    ...
    output = run_target_repo_pr_plan_preview(
