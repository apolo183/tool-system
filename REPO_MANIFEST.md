...
| tests/**/* | executable acceptance suite | Verify formal contracts, module boundaries, security controls, replay, orchestration, and no-mutation claims. | test maintainers and module owners | ACTIVE | src/tool_system/**/*; blueprint/**/*; config/module_registry*; config/process_authority*; policy/**/* | local and hosted acceptance evidence | pytest full suite and focused negative fixtures | REGISTERED |
